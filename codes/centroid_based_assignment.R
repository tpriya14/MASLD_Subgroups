# =============================================
# Centroid-Based Assignment (Euclidean Distance)
# =============================================
# This script performs centroid-based cluster assignment using
# the same approach as the original code but with bug fixes.
# =============================================
